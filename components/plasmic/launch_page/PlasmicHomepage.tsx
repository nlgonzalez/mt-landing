...
import sty from "./PlasmicHomepage.module.css"; // plasmic-import: iReJFG4IrbrW/css
              ...
              <div className={classNames(projectcss.all, sty.columns__kOyWc)}>
                <div className={classNames(projectcss.all, sty.column___4BaQv)}>
                  <Stack__
                    as={"div"}
                    hasGap={true}
                    className={classNames(projectcss.all, sty.freeBox__q8EeE)}
                  >
                    <PlasmicImg__
                      alt={""}
                      ...
                      loading={"lazy"}
                      src={{
                        src: "/plasmic/launch_page/images/isoiconpng.png",
                        fullWidth: 698,
                        fullHeight: 170,
