...
import sty from "./PlasmicProduct.module.css"; // plasmic-import: BIpZDud4ZQfy/css
    ...
    >
      {renderPlasmicSlot({
        defaultContents: (
          <PlasmicImg__
            alt={""}
            className={classNames(sty.img__iIGnc)}
            displayHeight={"auto"}
            ...
            loading={"lazy"}
            src={{
              src: "/plasmic/launch_page/images/neckties2103471920Jpg.jpg",
              fullWidth: 1920,
              fullHeight: 1280,
